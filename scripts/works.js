const alanis = [
  "./assets/works/services.png",
  "./assets/works/works.png",
  "./assets/works/contact.png",
  "./assets/works/home.png",
];
const alanisElement = document.getElementById("alanis");

const wallit = ["./assets/works/heavenly2.png", "./assets/works/heavenly1.png"];
const wallitElement = document.getElementById("wallit");

const firewatch = [
  "./assets/works/firewatch2.png",
  "./assets/works/firewatch3.png",
  "./assets/works/firewatch4.png",
  "./assets/works/firewatch1.png",
];
const firewatchElement = document.getElementById("firewatch");

const rps = [
  "./assets/works/rps2.png",
  "./assets/works/rps3.png",
  "./assets/works/rps4.png",
  "./assets/works/rps5.png",
  "./assets/works/rps1.png",
];
